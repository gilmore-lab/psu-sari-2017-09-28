...
- Interests in brain development, perceptual and cognitive development, big data, open science, 
...
>- is easier than most PIs think
>- improves the reproducibility and robustness of research
>- maximizes benefits of participation in research
>- can be accomplished for most types of data with appropriate planning and permission
>- is increasingly mandatory for funders and journals
>- is both a PI and institutional responsibility
    
## Data hoarding 

- is the norm in some fields (e.g., psychology & neuroscience)
...
## [Belmont principle](https://www.hhs.gov/ohrp/regulations-and-policy/belmont-report/index.html) of Beneficence
    
>- Data sharing may pose risk of loss of privacy & confidentiality
>- **But data sharing increases value**

## [Belmont principle](https://www.hhs.gov/ohrp/regulations-and-policy/belmont-report/index.html) of Autonomy

>- Data sharing may pose risk of unintended use of data
>- **But participants should participate in decisionmaking**

## [Belmont principle](https://www.hhs.gov/ohrp/regulations-and-policy/belmont-report/index.html) of Justice
...
- Should partner with PIs 
    - to make planning for data sharing part of the grant seeking & reporting process
    - to ensure data are as well-curated and managed as are the $

## Compliance office/IRB role

>- Data ~~destruction~~ sharing in secure repository for ~~limited~~ indefinite period
>- Support ~~narrow~~ broad secondary use cases
...
### <http://gilmore-lab.github.io/psu-sari-2017-09-28/>
